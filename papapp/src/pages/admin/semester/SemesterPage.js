...
const SemesterPage = () => {
    ...
    return (
        <>
            ...
            <List listName='Lista semestrów' columnNames={['Kod', 'Data początku', 'Data końca']} data={semesters} error={error} adminButtons={client.userTypeId == 0 && true} userButtons={true} handleDelete={handleDeleteSemester} handleEdit={handleEditSemester} handleView={handleVievCoursesInSemester} id="semester_code" />
        </>
    )
}
